// Central 0G testnet configuration. Server-only values are read from env.
...
// Contract minimums: ledger >= 3 OG, new provider sub-account >= 1 OG.
...
// Curated, public testnet providers (TEE-verifiable inference).
